...
<script src="<?= base_url().'assets/jquery-migrate.min.js' ?> " type="text/javascript"></script>
<script src="<?= base_url().'assets/bootstrap/js/bootstrap.min.js' ?>  " type="text/javascript"></script>

<!-- PAGE LEVEL PLUGINS -->
<script src="<?= base_url().'assets/jquery.easing.js' ?> " type="text/javascript"></script>
<script src="<?= base_url().'assets/jquery.back-to-top.js' ?> " type="text/javascript"></script>
<script src="<?= base_url().'assets/jquery.smooth-scroll.js' ?> " type="text/javascript"></script>
<script src="<?= base_url().'assets/jquery.wow.min.js' ?> " type="text/javascript"></script>
<script src="<?= base_url().'assets/jquery.parallax.min.js' ?> " type="text/javascript"></script>
<script src="<?= base_url().'assets/jquery.appear.js' ?> " type="text/javascript"></script>
